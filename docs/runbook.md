...
- 对 `data/stage1/train_5000.jsonl` 做 full-harvest
- 每题采样 `4` 个 responses
- 保留全量 `raw_samples`
...
当前默认主线 [configs/on_policy/loop.yaml](/home/chy/code/active/post_train/configs/on_policy/loop.yaml) 是 `512 prompt / round`；如果要跑论文迁移版 `opSFT`，优先看 [on_policy.md](/home/chy/code/active/post_train/docs/runbooks/on_policy.md) 里的 `loop_opsft.yaml`。
